    ...
    (o.init = () => {
        ...
        function n(e) {
            navigator.mediaDevices
                .getUserMedia(e)
                .then(function (e) {
                    (o.webcam.srcObject = e),
                        o.webcam.setAttribute("playsinline", !0),
                        o.webcam.setAttribute("controls", !0),
                        setTimeout(() => {
        ...
        i(),
            o.setCanvas(),
            (o.decoder = new Worker("decoder.js")),
            window.isMediaStreamAPISupported
                ? o.webcam.addEventListener(
                      "play",
                      function (e) {
                          t || (a(), (t = !0));
                      },
            ...
            window.isMediaStreamAPISupported &&
                navigator.mediaDevices
                    ...
                    .then(function (e) {
                        ...
                        a.length > 1
                            ? ((t = { video: { mandatory: { sourceId: a[a.length - 1].deviceId ? a[a.length - 1].deviceId : null } }, audio: !1 }), window.iOS && (t.video.facingMode = "environment"), n(t))
                            : a.length
                            ? ((t = { video: { mandatory: { sourceId: a[0].deviceId ? a[0].deviceId : null } }, audio: !1 }),
                              window.iOS && (t.video.facingMode = "environment"),
                              t.video.mandatory.sourceId || window.iOS ? n(t) : n({ video: !0 }))
                            : n({ video: !0 });
                    })
                    .catch(function (e) {
...
"serviceWorker" in navigator &&
    ...
    window.addEventListener("DOMContentLoaded", () => {
        ...
        function y(t = !1) {
            window.isMediaStreamAPISupported && !window.noCameraPermission && ((c.style.display = "block"), (l.style.display = "block")),
                t && ((c.style.display = "block"), (l.style.display = "block")),
                o.scan((t) => {
                    (e = t),
                        (s.value = t),
                        s.select(),
                        ...
                        ((e = "") =>
                            !(!e || "string" != typeof e) &&
                            new RegExp("^(https?:\\/\\/)?((([a-z\\d]([a-z\\d-]*[a-z\\d])*)\\.)+[a-z]{2,}|((\\d{1,3}\\.){3}\\d{1,3}))(\\:\\d+)?(\\/[-a-z\\d%_.~+]*)*(\\?[;&a-z\\d%_.~+=-]*)?(\\#[-a-z\\d_]*)?$", "i").test(e))(t) &&
                            (d.style.display = "inline-block"),
                        i.classList.remove("app__dialog--hide"),
                        n.classList.remove("app__dialog--hide");
                }, t);
        }
        function w() {
                        ...
                        o.appendChild(e),
                            ...
                            e.addEventListener("change", (e) => {
                                e.target &&
                                    ...
                                    window.noCameraPermission || ((c.style.display = "block"), (l.style.display = "block")),
